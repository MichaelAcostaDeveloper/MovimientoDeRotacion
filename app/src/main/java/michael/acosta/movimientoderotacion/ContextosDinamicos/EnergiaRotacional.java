...
import michael.acosta.movimientoderotacion.Resultados.Resultados_energia_rotacional;
public class EnergiaRotacional extends AppCompatActivity {
    EditText ed1, ed2, ed3, ed4, ed5;
    double valor1, valor2, valor3, valor4, valor5, dw, dE,I, Eo,Ef, wo,wf;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_energia_rotacional);
        ...
        text3.setText(Html.fromHtml("Ec<sub>o</sub>:"));
        ...
        text4.setText(Html.fromHtml("Ec<sub>f</sub>:"));
        ...
        switch (dato){
            case 1:
                if (ed1.getText().toString().isEmpty() & ed2.getText().toString().isEmpty()){
                    ...
                    Intent x = new Intent(this, Resultados_energia_rotacional.class);//cambiar la actividad de respuestas
            ...
            case 2:
                if (ed1.getText().toString().isEmpty() & ed3.getText().toString().isEmpty()){
                    ...
                    if(valor3<0){
                        dialogo_alerta_energia(view).show();
                    }else if(valor1==0){
            ...
            case 7:
                if (ed3.getText().toString().isEmpty() & ed5.getText().toString().isEmpty()){
                    ...
                    valor3 = conversor_Numero(ed3.getText().toString());
                    valor5 = conversor_Numero(ed5.getText().toString());
                    if ((valor3 < 0 & valor5 <= 0) || (valor3 < 0 || valor5 <= 0)) {
                        dialogo_general(view).show();
                    } else {
                        Intent x = new Intent(this, Resultados_energia_rotacional.class);//cambiar la actividad de respuestas
            ...
            case 8:
                if (ed4.getText().toString().isEmpty() & ed5.getText().toString().isEmpty()){
                    ...
                    valor4 = conversor_Numero(ed4.getText().toString());
                    valor5 = conversor_Numero(ed5.getText().toString());
                    if ((valor4 < 0 & valor5 <= 0) || (valor4 < 0 || valor5 <= 0)) {
                        dialogo_general(view).show();
                    } else {
                        Intent x = new Intent(this, Resultados_energia_rotacional.class);//cambiar la actividad de respuestas
...
//metodos de funcionamiento
    ...
    public double energia1(double a, double b) {
        return ((0.5*a)*Math.pow(b,2));
    }
    public double trabajo(double a, double b) {
        return (a-b);
    }
    public double velocidad(double a, double b) {return (Math.sqrt((2*a)/b));}
    ...
    public Dialog dialogo_alerta_energia(View view) {
        AlertDialog.Builder builder = new AlertDialog.Builder(this, R.style.TemaDialogoAlertas);
        //builder.setTitle("Información");
        builder.setMessage("El valor de la energia rotacional es positivo.");
        builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                dialog.cancel();
    ...
    public Dialog dialogo_general(View view) {
        AlertDialog.Builder builder = new AlertDialog.Builder(this, R.style.TemaDialogoAlertas);
        //builder.setTitle("Información");
        builder.setMessage("El valor de la energia e inercia rotacional son positivos.");
        builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                dialog.cancel();
    ...
    public Dialog dialogo_velocidad(View view) {
        AlertDialog.Builder builder = new AlertDialog.Builder(this, R.style.TemaDialogoAlertas);
        //builder.setTitle("Información");
        builder.setMessage("La velocidad angular no puede ser 0 si existe energía cinética.");
        builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                dialog.cancel();
